...
export class enGiftCatalog {
  ...
  init() {
    ...
    const boxMessage =
      options.boxMessage || this.translate("Care Package Total");
  ...
  getCustomDonationAmount() {
    ...
    customAmount.addEventListener("input", function (e) {
      if (e.target.value === "") {
        ...
        thisClass.updateInput(this.customDonationAmount);
      }
    });
  }
  ...
  moveBasicFields() {
    ...
    <div class="en__component en__component--row en__component--row--1 en__component--complete-heading">
      <div class="en__component en__component en__component--column en__component--column--1">
        <h1>${this.translate(
          "Complete Your"
        )} $<div class="totalAmount">0</div> <span class="monthly" style="display: none">${this.translate(
        "Monthly"
      )}</span> ${this.translate("Donation")}</h1>
      </div>
    </div>`
    );
    ...
    options.donations.forEach((e, i) => {
      ...
      <div class="en__component--wrap">
        <div class='en__component--donationAmount ${
          e.urgent ? this.translate("urgent") : ""
        }'>${
        ...
        <div class="en__component en__component--content">
          ...
          <div class="en__component--quantity">${this.translate(
            "Quantity"
          )}</div>
    ...
    if (options.customAmount) {
      ...
      <div class="en__component en__component en__component--column">
        <div class="en__component--wrap en__component--customAmount">
          <div class="en__component en__component--content">
            <h1>${this.translate("Additional gift of your choice")}</h1>
            <div class='en__component--customDonationAmount-wrap'>
              <div class='en__component--customDonationAmount'>
                <input type="number" step="any" placeholder="${this.translate(
                  "Other Amount"
                )}" min="0" value="${
        localStorage.getItem("customDonation")
          ? localStorage.getItem("customDonation")
          : 0
                ...
                <div class="en__component--usd">${this.translate(
                  "_CURRENCY"
                )}</div>
              </div>
            </div>
  ...
  translate(term) {
    ...
    const translations = {
      "en-US": {
        "Care Package Total": "Care Package <br> Total",
        ...
        "Additional gift of your choice":
          "Additional gift <br> of your choice:",
        "Other Amount": "Other Amount",
        _CURRENCY: "USD",
      },
      "de-DE": {
        "Care Package Total": "Care-Paket <br> insgesamt",
        "Complete Your": "Fülle dein",
        Monthly: "monatlich",
        Donation: "Spende",
        urgent: "dringend",
        Quantity: "Menge",
        "Additional gift of your choice": "Zusätzliche <br> Geschenk-Wahl:",
