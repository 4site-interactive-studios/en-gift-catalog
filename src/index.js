...
const checkbox = recurrPay.querySelector('.en__field__element--checkbox .en__field__item');
...
function displayDonations() {
  ...
  donations.forEach(e => {
    ...
    <div class="en__component--wrap">
      <div class='en__component--donationAmount ${e.urgent ? 'urgent' : '' }'>${e.donationAmount}</div>
  ...
  function createSelectAmount(slider, index) {
    ...
    values.push({value: donationAmount, amount: 0});
