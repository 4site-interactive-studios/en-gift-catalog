...
window.addEventListener("DOMContentLoaded", function (event) {
  ...
  if (inputDonation) {
    ...
    window.addEventListener("load", function () {
      ...
      updateInput(+document.querySelector(".en__component--customDonationAmount input").value);
