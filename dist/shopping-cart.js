...
window.addEventListener('DOMContentLoaded', function (event) {
  ...
  if (inputDonation) {
    ...
    window.addEventListener('load', function () {
      displayDonations(); // moveBasicFields();
      // lastElement();
      // wrapElements();
