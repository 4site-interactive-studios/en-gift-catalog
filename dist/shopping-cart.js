...
var options = {
  title: "<strong>Select git(s)</strong> (select as many as you would like):",
  customAmount: true,
...
function lastElement() {
  var row2 = document.querySelectorAll(".en__component--row--2");
  var lastColumn = row2[row2.length - 1];
  var lastColumnChild = lastColumn.lastElementChild;
