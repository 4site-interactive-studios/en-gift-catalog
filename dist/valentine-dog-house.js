...
var options = {
  ...
  donations: [{
    ...
    urgent: false,
    donationAmount: "5",
    imageURL: "https://acb0a5d73b67fccd4bbe-c2d8138f0ea10a18dd4c43ec3aa4240a.ssl.cf5.rackcdn.com/10003/Shop-Food-For-Week.jpg?v=1625507654000",
    ...
    urgent: false,
    donationAmount: "12",
    imageURL: "https://acb0a5d73b67fccd4bbe-c2d8138f0ea10a18dd4c43ec3aa4240a.ssl.cf5.rackcdn.com/10003/Shop-Toy-SDH21.jpg?v=1625507668000",
    ...
    urgent: false,
    donationAmount: "30",
    imageURL: "https://acb0a5d73b67fccd4bbe-c2d8138f0ea10a18dd4c43ec3aa4240a.ssl.cf5.rackcdn.com/10003/Shop-Medicine-SDH21.jpg?v=1625507655000",
    ...
    urgent: false,
    donationAmount: "100",
    imageURL: "https://acb0a5d73b67fccd4bbe-c2d8138f0ea10a18dd4c43ec3aa4240a.ssl.cf5.rackcdn.com/10003/Shop-Vet-Care-SDH21.jpg?v=1625507670000",
    ...
    urgent: false,
    donationAmount: "265",
    imageURL: "https://acb0a5d73b67fccd4bbe-c2d8138f0ea10a18dd4c43ec3aa4240a.ssl.cf5.rackcdn.com/10003/Shop-Doghouse-SDH21.jpg?v=1625507652000",
...
window.addEventListener("DOMContentLoaded", function (event) {
  ...
  if (inputDonation) {
    ...
    window.addEventListener("load", function () {
      ...
      updateInput(0);
      setTabIndex([".en__component--customDonationAmount input", "#en__field_pseudo_currencyConverter", "#en__field_supporter_firstName", "#en__field_supporter_lastName", "#en__field_supporter_address1", "#en__field_supporter_address2", "#en__field_supporter_country", "#en__field_supporter_postcode", "#en__field_supporter_city", "#en__field_supporter_region", "#en__field_supporter_emailAddress", "#en__field_transaction_paymenttype", "#en__field_transaction_ccnumber", "#en__field_transaction_ccvv", "#en__field_transaction_ccexpire", "select[name='transaction.ccexpire']", ".en__submit button"]);
  ...
  function displayDonations() {
    ...
    options.donations.forEach(function (e, i) {
  ...
  function updateInput(customAmount) {
    var carePackagesTotal = document.querySelectorAll(".totalAmount");
    var result = values.reduce(function (acc, current) {
      return acc + current.value * current.amount;
    }, 0);
    carePackagesTotal.forEach(function (total) {
  ...
  function wrapElements() {
    ...
    ccWrap.insertAdjacentElement("beforeend", ccexpire); // Placed here because it's dependent on other elements to have been moved/wrapped before it fires

    var postCode2 = document.querySelector(".email--signup");
    var ccWrap2 = document.querySelector(".en__field--ccwrap");
